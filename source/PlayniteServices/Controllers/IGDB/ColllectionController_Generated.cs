...
{
    public AgeRatingCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("age_ratings", igdb, settings)
    {
    }
}
...
{
    public AgeRatingContentDescriptionCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("age_rating_content_descriptions", igdb, settings)
    {
    }
}
...
{
    public AlternativeNameCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("alternative_names", igdb, settings)
    {
    }
}
...
{
    public ArtworkCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("artworks", igdb, settings)
    {
    }
}
...
{
    public CharacterCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("characters", igdb, settings)
    {
    }
}
...
{
    public CharacterMugShotCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("character_mug_shots", igdb, settings)
    {
    }
}
...
{
    public CollectionCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("collections", igdb, settings)
    {
    }
}
...
{
    public CompanyCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("companies", igdb, settings)
    {
    }
}
...
{
    public CompanyLogoCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("company_logos", igdb, settings)
    {
    }
}
...
{
    public CompanyWebsiteCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("company_websites", igdb, settings)
    {
    }
}
...
{
    public CoverCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("covers", igdb, settings)
    {
    }
}
...
{
    public ExternalGameCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("external_games", igdb, settings)
    {
    }
}
...
{
    public FranchiseCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("franchises", igdb, settings)
    {
    }
}
...
{
    public GameCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("games", igdb, settings)
    {
    }
}
...
{
    public GameEngineCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("game_engines", igdb, settings)
    {
    }
}
...
{
    public GameEngineLogoCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("game_engine_logos", igdb, settings)
    {
    }
}
...
{
    public GameLocalizationCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("game_localizations", igdb, settings)
    {
    }
}
...
{
    public GameModeCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("game_modes", igdb, settings)
    {
    }
}
...
{
    public GameVersionCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("game_versions", igdb, settings)
    {
    }
}
...
{
    public GameVersionFeatureCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("game_version_features", igdb, settings)
    {
    }
}
...
{
    public GameVersionFeatureValueCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("game_version_feature_values", igdb, settings)
    {
    }
}
...
{
    public GameVideoCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("game_videos", igdb, settings)
    {
    }
}
...
{
    public GenreCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("genres", igdb, settings)
    {
    }
}
...
{
    public InvolvedCompanyCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("involved_companies", igdb, settings)
    {
    }
}
...
{
    public KeywordCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("keywords", igdb, settings)
    {
    }
}
...
{
    public LanguageCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("languages", igdb, settings)
    {
    }
}
...
{
    public LanguageSupportCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("language_supports", igdb, settings)
    {
    }
}
...
{
    public LanguageSupportTypeCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("language_support_types", igdb, settings)
    {
    }
}
...
{
    public MultiplayerModeCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("multiplayer_modes", igdb, settings)
    {
    }
}
...
{
    public PlatformCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("platforms", igdb, settings)
    {
    }
}
...
{
    public PlatformFamilyCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("platform_families", igdb, settings)
    {
    }
}
...
{
    public PlatformLogoCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("platform_logos", igdb, settings)
    {
    }
}
...
{
    public PlatformVersionCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("platform_versions", igdb, settings)
    {
    }
}
...
{
    public PlatformVersionCompanyCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("platform_version_companies", igdb, settings)
    {
    }
}
...
{
    public PlatformVersionReleaseDateCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("platform_version_release_dates", igdb, settings)
    {
    }
}
...
{
    public PlatformWebsiteCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("platform_websites", igdb, settings)
    {
    }
}
...
{
    public PlayerPerspectiveCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("player_perspectives", igdb, settings)
    {
    }
}
...
{
    public RegionCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("regions", igdb, settings)
    {
    }
}
...
{
    public ReleaseDateCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("release_dates", igdb, settings)
    {
    }
}
...
{
    public ReleaseDateStatusCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("release_date_statuses", igdb, settings)
    {
    }
}
...
{
    public ScreenshotCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("screenshots", igdb, settings)
    {
    }
}
...
{
    public ThemeCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("themes", igdb, settings)
    {
    }
}
...
{
    public WebsiteCollectionController(IgdbApi igdb, UpdatableAppSettings settings) : base("websites", igdb, settings)
    {
    }
}
